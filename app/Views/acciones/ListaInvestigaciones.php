    ...
    <tbody>
      ...
      ?>
        <tr>
          ...
          <td><a class="btn btn-primary" href="http://localhost/cursoCodeIgniter-Udemy/index.php/investigaciones/ver/<?php echo $investigacion['id_investigacion'] ?>" role="button">Abrir</a></td>
        </tr>
      <?php endforeach; ?>
    </tbody>
  </table>
